...
| **BM** | O(m+|Σ|) | O(n/m) | O(n×m) | O(n/m) | O(m+|Σ|) | 长主串，大字符集 |
...
- [[../../../../按学科笔记/07_data_structures_cpp/01_lecture_notes/02_第2章_线性表]] - 线性结构的基础
- [[第3章：栈和队列]] - 受限的线性结构
- [[../../../../按学科笔记/07_data_structures_cpp/01_lecture_notes/05_第5章_树和二叉树]] - 非线性结构
