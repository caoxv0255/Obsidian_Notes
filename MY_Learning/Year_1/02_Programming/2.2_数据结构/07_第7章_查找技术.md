...
flowchart TD
    A[开始] --> B[root == null?]
    B -->|是| C[返回false]
    B -->|否| D{target == root->data?}
    D -->|是| E[返回true]
    D -->|否| F{target < root->data?}
    F -->|是| G[在左子树查找]
    F -->|否| H[在右子树查找]
    G --> I[递归查找]
    H --> I
...
- [[../../../../按学科笔记/07_data_structures_cpp/01_lecture_notes/02_第2章_线性表]] - 顺序表和链表是查找的基础
- [[../../../../按学科笔记/07_data_structures_cpp/01_lecture_notes/05_第5章_树和二叉树]] - BST和AVL树的基础
- [[../../../../按学科笔记/07_data_structures_cpp/01_lecture_notes/06_第6章_图]] - 图的查找算法
- [[../../../../按学科笔记/07_data_structures_cpp/01_lecture_notes/08_第8章_排序技术]] - 排序是二分查找的前提
