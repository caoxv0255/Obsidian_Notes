...
- [[按学科笔记/01_mathematics/calculus/21_multiple_integrals]] - 重积分（曲线积分的基础）
- [[按学科笔记/01_mathematics/calculus/23_surface_integrals]] - 曲面积分（曲线积分的推广）
- [[23_Vector_Calculus]] - 向量微积分（曲线积分的应用）
- [[../../../MY_Learning/Year_2/04_ML/4.1_Python数据科学/06_Case_Finance]] - 金融案例（路径规划的应用）
